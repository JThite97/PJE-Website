  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 pt-32 pb-24">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-8 tracking-tight font-display">Privacy Policy</h1>
          ...
          <div className="prose prose-slate max-w-none prose-headings:font-display prose-headings:font-bold prose-a:text-brand-600 hover:prose-a:text-brand-700">
            ...
            <p>Welcome to PJ Enterprise. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website (regardless of where you visit it from) and tell you about your privacy rights and how the law protects you.</p>
            ...
            <p>
              Email: privacy@pjenterprise.in<br />
              Post: P J Enterprise, GIDC Makarpura, Vadodara, Gujarat, India
            </p>
          </div>
        </motion.div>
      </div>
